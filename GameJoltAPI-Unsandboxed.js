...
(Scratch => {
	...
	GJAPI.DataStoreFetch = function (b, a, c) { GJAPI.SendRequest("/data-store/?key=" + a, b, c) }; GJAPI.DataStoreUpdate = function (b, a, c, d, e) { GJAPI.SendRequest("/data-store/update/?key=" + a + "&operation=" + c + "&value=" + d, b, e) }; GJAPI.DataStoreRemove = function (b, a, c) { GJAPI.SendRequest("/data-store/remove/?key=" + a, b === GJAPI.DATA_STORE_USER, c) }; GJAPI.DataStoreGetKeys = function (b, a) { GJAPI.SendRequest("/data-store/get-keys/", b === GJAPI.DATA_STORE_USER, a) };
	...
	class GameJoltAPI {
		...
		dataStoreSet(args) {
			GJAPI.DataStoreSet(args.globalOrPerUser == bool.t, args.key, args.data);
		}
		dataStoreFetch(args) {
