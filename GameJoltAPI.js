...
GJAPI.TrophyFetch=function(b,a){if(!GJAPI.bLoggedIn){GJAPI.LogTrace("TrophyFetch("+b+") failed: no user logged in");a={success:'false',message: 'No user logged in'};return;}var sTrophyData=(b===GJAPI.TROPHY_ALL)?"":"?achieved="+((b>=GJAPI.TROPHY_ONLY_ACHIEVED)?"true":"false");GJAPI.SendRequest("/trophies/"+sTrophyData,GJAPI.SEND_FOR_USER,a);};GJAPI.TrophyFetchSingle=function(b,a){GJAPI.bLoggedIn?GJAPI.SendRequest("/trophies/?trophy_id="+b,GJAPI.SEND_FOR_USER,a):GJAPI.LogTrace("TrophyFetchSingle("+b+") failed: no user logged in")};GJAPI.SCORE_ONLY_USER=!0;GJAPI.SCORE_ALL=!1;
