...
f.substr(g+1);e({success:String("FAILURE" !== h),data:f});break;default:e(f)}})};GJAPI.bLoggedIn=GJAPI.bAutoLogin&&GJAPI.asQueryParam.gjapi_username&&GJAPI.asQueryParam.gjapi_token?!0:!1;GJAPI.sUserName=GJAPI.bLoggedIn?GJAPI.asQueryParam.gjapi_username:"";GJAPI.sUserToken=GJAPI.bLoggedIn?GJAPI.asQueryParam.gjapi_token:"";console.info(GJAPI.asQueryParam);console.info(GJAPI.sLogName+(GJAPI.bOnGJ?" E":" Not e")+"mbedded on Game Jolt <"+window.location.origin+window.location.pathname+">");
...
class GameJoltAPI {
    ...
    dataStoreFetch(args) {
        GJAPI.DataStoreFetch(args.globalOrPerUser, args.key, function (pResponse) {
            if (pResponse.success == bool.f) { err.store = pResponse.data; return; }
