...
class GameJoltAPI {
    ...
    trophyFetch(args) {
        switch (args.indexOrID) {
            case 'index':
                ...
                if (trophyData[args.value] == undefined) { trophyData = err; return err; }
                switch (args.trophyDataType) {
                    case 'difficulty':
                        if (trophyData[args.value].difficulty == undefined) { trophyData = err; return err; }
                        return trophyData.difficulty;
                    case 'title':
                        if (trophyData[args.value].title == undefined) { trophyData = err; return err; }
                        return trophyData[args.value].title;
                    case 'description':
                        if (trophyData[args.value].description == undefined) { trophyData = err; return err; }
                        return trophyData[args.value].description;
                    case 'date':
                        if (trophyData[args.value].achieved == undefined) { trophyData = err; return err; }
            ...
            case 'ID':
                ...
                switch(args.trophyDataType) {
                    case 'difficulty':
                        if (trophyData.difficulty == undefined) { trophyData = err; return err; }
                        return trophyData.difficulty;
                    case 'title':
    ...
    returnScoreData(args) {
        if (scoreData[args.index] == undefined) { return err; }
    ...
    dataStoreFetch(args) {
        switch(args.globalOrPerUser) {
            case 'global':
                ...
                if (storeData == undefined) { return err; }
                return storeData;
            case 'user':
