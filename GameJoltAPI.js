...
class GameJoltAPI {
        ...
        return {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    blockIconURI: trophyIcon,
                    blockType: Scratch.BlockType.REPORTER,
                    text: 'Fetch trophy by [indexOrID]:[value]',
                    arguments: {
                        indexOrID: {
                            type: Scratch.ArgumentType.STRING,
                            menu: 'indexOrID',
            ...
            menus: {
                ...
                scoreDataTypes: {
                    items: ['value', 'text', 'username', 'date', 'extra data']
                },
                openOrClose: {
                    items: ['Open', 'Close']
                },
    ...
    returnScoreData(args) {
        ...
        switch (args.scoreDataType) {
            case 'value':
                if (scoreData[args.index]['score_value'] == undefined) { return err; }
                return scoreData[args.index]['score_value'];
            case 'text':
            ...
            case 'date':
                if (scoreData[args.index]['scored_on'] == undefined) { return err; }
                return scoreData[args.index]['scored_on'];
            case 'extra data':
    ...
    dataStoreGetKey(args) {
        switch(args.globalOrPerUser) {
            case 'global':
                ...
                if (keyData == undefined || keyData[args.index] == undefined || keyData[args.index].key == undefined) { return err; }
