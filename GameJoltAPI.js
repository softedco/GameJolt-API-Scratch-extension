...
class GameJoltAPI {
    ...
    returnUserData(args) {
        if (userData ?? true) { userData = err; return err; }
    ...
    trophyFetch(args) {
        ...
        switch(args.indexOrID) {
            case 'index':
                ...
                if (trophyData == err || (trophyData[args.value] ?? true)) { return err; }
    ...
    trophyAchieved(args) {
        ...
        switch(args.trophyType) {
            case 'achieved':
                ...
                if (achievedData == err || (achievedData[args.index] ?? true)) { return err; }
            ...
            case 'not achieved':
                ...
                if (notAchievedData == err || (notAchievedData[args.index] ?? true)) { return err; }
            ...
            case 'any':
                ...
                if (trophyData == err || (trophyData[args.index] ?? true)) { return err; }
