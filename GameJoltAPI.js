...
class GameJoltAPI {
    ...
    returnScoreData(args) {
        ...
        switch (args.scoreDataType) {
            case 'value':
                if (scoreData[args.index]['value'] == undefined) { return err; }
                return scoreData[args.index]['value'];
            case 'text':
            ...
            case 'date':
                if (scoreData[args.index]['date'] == undefined) { return err; }
                return scoreData[args.index]['date'];
            case 'extra data':
