        ...
        return {
            ...
            blocks: [
                ...
                },
                {
                    ...
                    blockIconURI: trophyIcon,
                    blockType: Scratch.BlockType.BOOLEAN,
                    text: 'Return [trophyType] trophy ID by index:[index]',
                    arguments: {
                        trophyType: {
                            type: Scratch.ArgumentType.STRING,
                            menu: 'trophyTypes',
    ...
    trophyAchieved(args) {
        ...
        switch(args.trophyType) {
            case 'achieved':
                ...
                achievedData = achievedData[args.index].id ?? err;
            ...
            case 'not achieved':
                ...
                notAchievedData = notAchievedData[args.index].id ?? err;
            ...
            case 'any':
                ...
                trophyData = trophyData[args.index].id ?? err;
                return trophyDataData[args.index].id;
            default:
                return err;
        }
    }
